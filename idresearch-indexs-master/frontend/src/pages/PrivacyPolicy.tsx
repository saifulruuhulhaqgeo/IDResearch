        ...
        <div className="felx-auto mt-24 w-full">
          <div className="flex">
            ...
            <div className="flex-none w-3/4 md:w-1/2">
              <h2 className="text-2xl font-bold mb-2">About This Policy</h2>
              <p>
                By using ID Research Network, users entrust their information to
                us. We understand that protecting user information and providing
                control to users is a big responsibility and requires hard work.
                We collect information in order to provide better service to all
                of our users, starting from basic things such as the language
                the user uses, search history, preferred search topics to more
                complex things such as email notifications which users find most
                useful for information about literature works and results of
                related searches, All user accounts are built with strong
                security features that protect user information continuously.
              </p>
              ...
              <p>
                This policy applies to all services offered by ID Research
                Network.
              </p>
              ...
              <p>
                We will periodically change this Privacy Policy from time to
                time (if needed). We will not reduce the user's rights in this
                Privacy Policy without the user's direct consent.
              </p>
              ...
              <p>
                If you have questions about ID Research Network, please contact
                ID Research Network information center or visit Help for further
                information.
              </p>
            </div>
