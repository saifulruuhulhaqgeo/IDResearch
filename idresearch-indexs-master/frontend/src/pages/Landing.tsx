...
import AreaClickModalNoMap from '../components/AreaClickModalNoMap';
    ...
    <>
      ...
      <div className="flex">
        ...
        <div className="felx-auto mt-24 w-full">
          <div className="py-2 px-4 font-bold text-lg flex">
            <div className="flex-auto"></div>

            <div className="flex-none">
              <img src={MainLogo} className="w-52 " />
            </div>
          ...
          <div className="flex">
            ...
            <div className="flex-none w-3/4 md:w-1/2">
              <SmartSearchBarNoLeaflet
                showModal={true}
                onCloseModal={() => {}}
                modalParam={null}
                onClickSuggestion={(keyword) => {
                  console.log('keywrord', keyword);
              ...
              />
              <img className="mt-10" src={BgMap} alt="map" />
            </div>
      ...
      <footer className="px-4  dark:bg-gray-900 bg-gray-500">
        <div className="md:flex md:justify-between">
          ...
          <div className="mb-6 md:mb-0 flex  items-center w-full mr-6 ">
            ...
            <div className="text-white ml-4 border-r-[#ffc200] md:border-r-4 md:border-t-0 md:border-l-0 md:border-b-0 md:h-16 my-2">
